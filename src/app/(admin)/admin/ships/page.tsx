  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-10">
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Link
          href="/admin/agent-delete"
          className="rounded-xl border border-neutral-800 bg-neutral-950 p-5 hover:bg-neutral-900"
        >
          <div className="text-sm font-semibold">Delete agent</div>
          <div className="mt-1 text-xs text-neutral-500">Delete an agent and all ships by agent_id.</div>
        </Link>
