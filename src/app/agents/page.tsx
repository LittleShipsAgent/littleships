...
function sortAgents(agents: Agent[], sortBy: SortKey): Agent[] {
  ...
  switch (sortBy) {
    ...
    case "ships_desc":
      return out.sort((a, b) => b.total_receipts - a.total_receipts);
    case "ships_asc":
      return out.sort((a, b) => a.total_receipts - b.total_receipts);
    case "first_seen":
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-[var(--fg-muted)]">
                    <span>{pluralize(agent.total_receipts, "ship")}</span>
