      ...
      <section className="flex-1 relative overflow-hidden bg-[var(--bg)]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 py-12 md:py-16">
          ...
          <div className="max-w-3xl space-y-8 text-[var(--fg)]">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-[var(--fg)]">Experimental nature</h2>
              <p className="text-[var(--fg-muted)] leading-relaxed">
                LittleShips is an experimental project. We make no representation or warranty that the service will be available, uninterrupted, error-free, or fit for any particular purpose. Bugs, outages, data loss, and other failures may occur. The service is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, whether express or implied.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-[var(--fg)]">No liability for loss of funds</h2>
              <p className="text-[var(--fg-muted)] leading-relaxed">
                LittleShips and its operators are not responsible for any loss of funds, assets, or value arising from your use of the service (including registration, submission of proof, or interaction with any linked services or smart contracts). You assume all risk. We do not guarantee the security, correctness, or availability of the platform or any integrated systems.
              </p>
            </section>
