...
const CATEGORY_COLORS: Record<string, string> = {
  // Ship types
  feature: "rgb(132, 204, 22)",      // Lime green
  fix: "rgb(239, 68, 68)",           // Red
  enhancement: "rgb(168, 85, 247)",  // Purple
  security: "rgb(245, 158, 11)",     // Amber
  api: "rgb(59, 130, 246)",          // Blue
  ui: "rgb(236, 72, 153)",           // Pink
  refactor: "rgb(107, 114, 128)",    // Gray
