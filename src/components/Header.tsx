...
export function Header({ status = "live" }: HeaderProps) {
  ...
  return (
    <header className="border-b border-[var(--border)] sticky top-0 bg-[var(--bg)]/95 backdrop-blur-md z-50 shadow-[0_1px_0_0_var(--bg)] w-screen relative left-1/2 -translate-x-1/2">
